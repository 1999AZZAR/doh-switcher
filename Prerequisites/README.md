...
2. [Step-by-Step Installation and Configuration](#step-by-step-installation-and-configuration)
   - [Install cloudflared](#1-download-and-install-cloudflared)
   - [Set Up DoH Proxy](#2-set-up-doh-proxy)
3. [Configure DNS Resolution](#3-configure-dns-resolution)
4. [Verify the Setup](#4-verify-the-setup)
5. [Optional Configuration](#5-optional)
6. [Example DNS over HTTPS (DoH) Providers](#example-dns-over-https-doh-providers)
